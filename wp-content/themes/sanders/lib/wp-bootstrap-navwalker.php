	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			...
			// Add an href attribute if it's not empty
			$atts['href'] = ! empty( $item->url ) ? $item->url : '';
			...
			//$item_output .= ( $args->has_children && 0 === $depth ) ? ' </a><i class="fa fa-plus"></i>' : '</a>';
			$item_output .= ( $args->has_children ) ? ' </a><i class="fa fa-angle-down"></i>' : '</a>';
